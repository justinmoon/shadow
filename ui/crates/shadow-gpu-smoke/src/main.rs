...
fn build_summary(config: &Config) -> Result<SmokeSummary, String> {
    ...
    if matches!(config.scene, RenderScene::RawKgslOpenReadOnlySmoke) {
        return Ok(SmokeSummary::RawKgslOpenReadOnly(
            build_raw_kgsl_open_readonly_smoke_summary(config)?,
        ));
    }
    ...
    if matches!(
        ...
        return Ok(SmokeSummary::RawVulkanPhysicalDeviceCountQueryNoDestroy(
            build_raw_vulkan_physical_device_count_query_no_destroy_smoke_summary(config)?,
        ));
    }

    if matches!(config.scene, RenderScene::RawVulkanPhysicalDeviceCountSmoke) {
        return Ok(SmokeSummary::RawVulkanPhysicalDeviceCount(
            build_raw_vulkan_physical_device_count_smoke_summary(config)?,
        ));
    }
    ...
    if matches!(
        ...
        return Ok(SmokeSummary::RawVulkanPhysicalDeviceCountQuery(
            build_raw_vulkan_physical_device_count_query_smoke_summary(config)?,
        ));
    }
...
fn build_raw_vulkan_physical_device_count_smoke_summary(
    config: &Config,
) -> Result<RawVulkanPhysicalDeviceCountSmokeSummary, String> {
    eprintln!("[shadow-gpu-smoke] raw-vulkan-physical-device-count-smoke: load-entry");
    let entry =
        unsafe { ash::Entry::load() }.map_err(|error| format!("load vulkan entry: {error}"))?;
    eprintln!("[shadow-gpu-smoke] raw-vulkan-physical-device-count-smoke: load-entry-ok");
    ...
    eprintln!("[shadow-gpu-smoke] raw-vulkan-physical-device-count-smoke: vkCreateInstance");
    let instance = unsafe { entry.create_instance(&create_info, None) }
        .map_err(|error| format!("vkCreateInstance: {error:?}"))?;
    eprintln!("[shadow-gpu-smoke] raw-vulkan-physical-device-count-smoke: vkCreateInstance-ok");

    eprintln!(
        "[shadow-gpu-smoke] raw-vulkan-physical-device-count-smoke: vkEnumeratePhysicalDevices"
    );
    let physical_devices = unsafe { instance.enumerate_physical_devices() }
        .map_err(|error| format!("vkEnumeratePhysicalDevices: {error:?}"))?;
    eprintln!(
        "[shadow-gpu-smoke] raw-vulkan-physical-device-count-smoke: vkEnumeratePhysicalDevices-ok count={}",
    ...
    eprintln!("[shadow-gpu-smoke] raw-vulkan-physical-device-count-smoke: destroy-instance-ok");

    Ok(RawVulkanPhysicalDeviceCountSmokeSummary {
...
fn build_raw_vulkan_physical_device_count_query_no_destroy_smoke_summary(
    config: &Config,
) -> Result<RawVulkanPhysicalDeviceCountQuerySmokeSummary, String> {
    eprintln!(
        "[shadow-gpu-smoke] raw-vulkan-physical-device-count-query-no-destroy-smoke: load-entry"
    );
    let entry =
        unsafe { ash::Entry::load() }.map_err(|error| format!("load vulkan entry: {error}"))?;
    eprintln!(
        "[shadow-gpu-smoke] raw-vulkan-physical-device-count-query-no-destroy-smoke: load-entry-ok"
    );
    ...
    eprintln!(
        "[shadow-gpu-smoke] raw-vulkan-physical-device-count-query-no-destroy-smoke: vkCreateInstance"
    );
    let instance = unsafe { entry.create_instance(&create_info, None) }
        .map_err(|error| format!("vkCreateInstance: {error:?}"))?;
    eprintln!(
        "[shadow-gpu-smoke] raw-vulkan-physical-device-count-query-no-destroy-smoke: vkCreateInstance-ok"
    );

    let mut physical_device_count = 0u32;
    eprintln!(
        "[shadow-gpu-smoke] raw-vulkan-physical-device-count-query-no-destroy-smoke: vkEnumeratePhysicalDevices-count-query"
    );
    let enumerate_result = unsafe {
        (instance.fp_v1_0().enumerate_physical_devices)(
            instance.handle(),
    ...
    eprintln!(
        "[shadow-gpu-smoke] raw-vulkan-physical-device-count-query-no-destroy-smoke: vkEnumeratePhysicalDevices-count-query-ok count={physical_device_count}"
    );
    ...
    Ok(RawVulkanPhysicalDeviceCountQuerySmokeSummary {
        ...
        queried_physical_device_count: physical_device_count,
...
fn build_raw_vulkan_physical_device_count_query_smoke_summary(
    config: &Config,
) -> Result<RawVulkanPhysicalDeviceCountQuerySmokeSummary, String> {
    eprintln!("[shadow-gpu-smoke] raw-vulkan-physical-device-count-query-smoke: load-entry");
    let entry =
        unsafe { ash::Entry::load() }.map_err(|error| format!("load vulkan entry: {error}"))?;
    eprintln!("[shadow-gpu-smoke] raw-vulkan-physical-device-count-query-smoke: load-entry-ok");
    ...
    eprintln!("[shadow-gpu-smoke] raw-vulkan-physical-device-count-query-smoke: vkCreateInstance");
    let instance = unsafe { entry.create_instance(&create_info, None) }
        .map_err(|error| format!("vkCreateInstance: {error:?}"))?;
    eprintln!(
        "[shadow-gpu-smoke] raw-vulkan-physical-device-count-query-smoke: vkCreateInstance-ok"
    );

    let mut physical_device_count = 0u32;
    eprintln!(
        "[shadow-gpu-smoke] raw-vulkan-physical-device-count-query-smoke: vkEnumeratePhysicalDevices-count-query"
    );
    let enumerate_result = unsafe {
        (instance.fp_v1_0().enumerate_physical_devices)(
            instance.handle(),
    ...
    eprintln!(
        "[shadow-gpu-smoke] raw-vulkan-physical-device-count-query-smoke: vkEnumeratePhysicalDevices-count-query-ok count={physical_device_count}"
    );
...
#[derive(Serialize)]
struct RawKgslOpenSmokeSummary {
    mode: &'static str,
    scene: &'static str,
    width: u32,
    height: u32,
...
fn open_kgsl_device(stage_name: &'static str, read: bool, write: bool) -> Result<fs::File, String> {
    ...
    eprintln!("[shadow-gpu-smoke] raw-kgsl-open: {stage_name}-ok");
    Ok(kgsl_file)
}

fn build_raw_kgsl_open_readonly_smoke_summary(
    config: &Config,
) -> Result<RawKgslOpenSmokeSummary, String> {
    let kgsl_file = open_kgsl_device("kgsl-open-readonly", true, false)?;
    drop(kgsl_file);

    Ok(RawKgslOpenSmokeSummary {
        mode: "raw-kgsl-open-readonly-smoke",
        scene: config.scene.as_str(),
        width: config.width,
        height: config.height,
...
fn build_raw_kgsl_getproperties_smoke_summary(
    ...
    let kgsl_file = open_kgsl_device("kgsl-open", true, true)?;
...
impl Config {
    fn parse(args: impl Iterator<Item = String>) -> Result<Self, String> {
        ...
        if hold_secs_specified && !present_kms {
            if matches!(scene, RenderScene::BundleSmoke) {
                ...
                RenderScene::InstanceSmoke
                    ...
                    | RenderScene::RawKgslOpenReadOnlySmoke
                ...
                return Err(format!(
                    "--scene instance-smoke, raw-vulkan-instance-smoke, raw-kgsl-open-readonly-smoke, raw-kgsl-getproperties-smoke, raw-vulkan-physical-device-count-query-exit-smoke, raw-vulkan-physical-device-count-query-no-destroy-smoke, raw-vulkan-physical-device-count-query-smoke, raw-vulkan-physical-device-count-smoke, enumerate-adapters-count-smoke, enumerate-adapters-smoke, adapter-smoke, device-request-smoke, and device-smoke do not support --hold-secs\n\n{}",
                    Self::usage()
                ));
            } else {
                return Err(format!(
        ...
        {
            return Err(format!(
                "--scene bundle-smoke, instance-smoke, raw-vulkan-instance-smoke, raw-kgsl-open-readonly-smoke, raw-kgsl-getproperties-smoke, raw-vulkan-physical-device-count-query-exit-smoke, raw-vulkan-physical-device-count-query-no-destroy-smoke, raw-vulkan-physical-device-count-query-smoke, raw-vulkan-physical-device-count-smoke, enumerate-adapters-count-smoke, enumerate-adapters-smoke, adapter-smoke, device-request-smoke, and device-smoke do not support --present-kms\n\n{}",
                Self::usage()
            ));
        }
        if matches!(
...
enum SmokeSummary {
    ...
    RawKgslOpenReadOnly(RawKgslOpenSmokeSummary),
...
#[derive(Serialize)]
struct RawVulkanPhysicalDeviceCountQuerySmokeSummary {
    mode: &'static str,
    scene: &'static str,
    width: u32,
    height: u32,
    ...
    instance_created: bool,
    instance_destroyed: bool,
    explicit_instance_destroy_attempted: bool,
    physical_device_count_queried: bool,
    queried_physical_device_count: u32,
    physical_device_handles_fetched: bool,
    physical_device_properties_read: bool,
    wgpu_adapter_enumeration_attempted: bool,
    adapter_selection_attempted: bool,
    device_requested: bool,
    summary_path: Option<String>,
...
#[derive(Serialize)]
struct RawVulkanPhysicalDeviceCountSmokeSummary {
    mode: &'static str,
    scene: &'static str,
    width: u32,
    height: u32,
    ...
    instance_destroyed: bool,
    physical_devices_enumerated: bool,
    enumerated_physical_device_count: usize,
    physical_device_properties_read: bool,
    wgpu_adapter_enumeration_attempted: bool,
    adapter_selection_attempted: bool,
    device_requested: bool,
...
impl RenderScene {
    fn parse(raw: String) -> Result<Self, String> {
        match raw.as_str() {
            ...
            "raw-kgsl-open-readonly-smoke" => Ok(Self::RawKgslOpenReadOnlySmoke),
            ...
            "raw-vulkan-physical-device-count-query-smoke" => {
                Ok(Self::RawVulkanPhysicalDeviceCountQuerySmoke)
            }
            "raw-vulkan-physical-device-count-smoke" => {
                Ok(Self::RawVulkanPhysicalDeviceCountSmoke)
            }
    ...
    const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::RawKgslOpenReadOnlySmoke => "raw-kgsl-open-readonly-smoke",
            ...
            Self::RawVulkanPhysicalDeviceCountQuerySmoke => {
                "raw-vulkan-physical-device-count-query-smoke"
            }
            Self::RawVulkanPhysicalDeviceCountSmoke => "raw-vulkan-physical-device-count-smoke",
