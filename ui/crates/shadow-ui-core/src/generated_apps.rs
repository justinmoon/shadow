...
use super::{AppId, AppLaunchEnv, AppModel, DemoApp, ManifestAppLaunch, ManifestAppRuntime};
use crate::color::{ICON_CYAN, ICON_GREEN, ICON_ORANGE, ICON_PINK, ICON_PURPLE, ICON_RED};
...
pub const COUNTER_MANIFEST_RUNTIME: ManifestAppRuntime = ManifestAppRuntime {
...
pub const CAMERA_MANIFEST_RUNTIME: ManifestAppRuntime = ManifestAppRuntime {
...
pub const TIMELINE_MANIFEST_RUNTIME: ManifestAppRuntime = ManifestAppRuntime {
...
pub const TIMELINE_APP: DemoApp = DemoApp {
    ...
    icon_label: "TL",
    title: "Timeline",
    subtitle: "Shared Nostr cache",
    lifecycle_hint:
        "Shelving keeps the latest cached feed warm. Full restart reloads shared notes.",
    binary_name: "shadow-blitz-demo",
...
pub const PODCAST_MANIFEST_RUNTIME: ManifestAppRuntime = ManifestAppRuntime {
...
pub const CASHU_MANIFEST_RUNTIME: ManifestAppRuntime = ManifestAppRuntime {
...
pub const RUST_TIMELINE_APP_ID: AppId = AppId::new("rust-timeline");
pub const RUST_TIMELINE_WAYLAND_APP_ID: &str = "dev.shadow.rust-timeline";
pub const RUST_TIMELINE_WINDOW_TITLE: &str = "Shadow Rust Timeline";
pub const RUST_TIMELINE_MODEL: AppModel = AppModel::Rust;
...
pub const RUST_TIMELINE_APP: DemoApp = DemoApp {
    id: RUST_TIMELINE_APP_ID,
    model: RUST_TIMELINE_MODEL,
    icon_label: "NR",
    title: "Rust Nostr",
    subtitle: "Shared Nostr engine",
    lifecycle_hint: "Shelving keeps the selected note and cache-backed feed one tap away.",
...
pub const VM_SHELL_DEMO_APPS: [DemoApp; 7] = [
    COUNTER_APP,
    CAMERA_APP,
    TIMELINE_APP,
    PODCAST_APP,
