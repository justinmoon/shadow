...
assert_file_contains "$REPO_ROOT/scripts/pixel/pixel_hello_init.c" 'return "bands-orange";'
assert_file_contains "$REPO_ROOT/scripts/pixel/pixel_hello_init.c" 'return "orange-vertical-band";'
