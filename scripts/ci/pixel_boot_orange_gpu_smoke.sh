...
assert_file_contains "$REPO_ROOT/scripts/pixel/pixel_hello_init.c" 'return "code-orange-5";'
assert_file_contains "$REPO_ROOT/scripts/pixel/pixel_hello_init.c" 'return "code-orange-6";'
assert_file_contains "$REPO_ROOT/scripts/pixel/pixel_hello_init.c" 'return "code-orange-7";'
assert_file_contains "$REPO_ROOT/scripts/pixel/pixel_hello_init.c" 'return "code-orange-8";'
